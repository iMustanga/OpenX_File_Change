...
"}")
        ...
        self.verticalLayout.addWidget(self.prescan_select_input)
        self.prescan_select_input_dir = QtWidgets.QPushButton(window_prescan)
        self.prescan_select_input_dir.setMinimumSize(QtCore.QSize(271, 41))
        self.prescan_select_input_dir.setStyleSheet("QPushButton{\n"
"border:2px solid rgb(85, 87, 83);\n"
"background-color: rgb(186, 189, 182);\n"
"border-radius:10px\n"
"}\n"
...
"border-radius:10px;\n"
"}")
        self.prescan_select_input_dir.setObjectName("prescan_select_input_dir")
        self.verticalLayout.addWidget(self.prescan_select_input_dir)
...
"border-radius:10px")
        ...
        self.gridLayout.addItem(spacerItem19, 15, 3, 1, 1)
...
"border-radius:10px")
        ...
        self.gridLayout.addItem(spacerItem22, 19, 3, 1, 1)
...
"border-radius:10px;\n"
"}")
        self.to_prescan.setObjectName("to_prescan")
        ...
        self.gridLayout.addItem(spacerItem26, 22, 3, 1, 1)
    ...
    def retranslateUi(self, window_prescan):
        ...
        self.prescan_select_input_dir.setText(_translate("window_prescan", "选择文件夹"))
