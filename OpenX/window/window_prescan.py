...
# Form implementation generated from reading ui file 'window_prescan.ui'
#
...
class Ui_window_prescan(object):
    def setupUi(self, window_prescan):
        ...
        self.blank_7 = QtWidgets.QPushButton(window_prescan)
...
"border-radius:25px")
        ...
        self.vtd_vehicle_model_select_3 = QtWidgets.QPushButton(window_prescan)
...
"border-radius:10px")
        ...
        self.blank_8 = QtWidgets.QPushButton(window_prescan)
...
"border-radius:25px")
        ...
        self.blank_9 = QtWidgets.QPushButton(window_prescan)
...
"border-radius:25px")
        ...
        self.vtd_vehicle_model_select_4 = QtWidgets.QPushButton(window_prescan)
...
"border-radius:10px")
        ...
        self.blank_10 = QtWidgets.QPushButton(window_prescan)
...
"border-radius:25px")
        ...
        self.prescan_vehicle_model_select = QtWidgets.QPushButton(window_prescan)
        self.prescan_vehicle_model_select.setMinimumSize(QtCore.QSize(271, 41))
        self.prescan_vehicle_model_select.setStyleSheet("QPushButton{\n"
...
"border-radius:10px;\n"
"}")
        self.prescan_vehicle_model_select.setObjectName("prescan_vehicle_model_select")
        self.horizontalLayout_2.addWidget(self.prescan_vehicle_model_select)
        spacerItem2 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.horizontalLayout_2.addItem(spacerItem2)
        self.prescan_vehicle_model_show = QtWidgets.QComboBox(window_prescan)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.prescan_vehicle_model_show.sizePolicy().hasHeightForWidth())
        self.prescan_vehicle_model_show.setSizePolicy(sizePolicy)
        self.prescan_vehicle_model_show.setMinimumSize(QtCore.QSize(541, 41))
        self.prescan_vehicle_model_show.setStyleSheet("border:2px solid rgb(186,186,186);\n"
"background-color: rgb(255, 255, 255);\n"
"border-radius:10px")
        self.prescan_vehicle_model_show.setObjectName("prescan_vehicle_model_show")
        self.horizontalLayout_2.addWidget(self.prescan_vehicle_model_show)
        ...
        self.vtd_vehicle_model_select_2 = QtWidgets.QPushButton(window_prescan)
...
"border-radius:10px")
        ...
        self.blank_12 = QtWidgets.QPushButton(window_prescan)
...
"border-radius:25px")
        ...
        self.vtd_vehicle_model_select_5 = QtWidgets.QPushButton(window_prescan)
...
"border-radius:10px")
        ...
        self.blank_11 = QtWidgets.QPushButton(window_prescan)
...
"border-radius:25px")
        ...
        self.prescan_select_output = QtWidgets.QPushButton(window_prescan)
        self.prescan_select_output.setMinimumSize(QtCore.QSize(271, 41))
        self.prescan_select_output.setStyleSheet("QPushButton{\n"
...
"border-radius:10px;\n"
"}")
        self.prescan_select_output.setObjectName("prescan_select_output")
        self.horizontalLayout_4.addWidget(self.prescan_select_output)
        spacerItem17 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.horizontalLayout_4.addItem(spacerItem17)
        self.prescan_show_output = QtWidgets.QLineEdit(window_prescan)
        self.prescan_show_output.setMinimumSize(QtCore.QSize(541, 41))
        self.prescan_show_output.setStyleSheet("border:2px solid rgb(186,186,186);\n"
"background-color: rgb(255, 255, 255);\n"
"border-radius:10px")
        self.prescan_show_output.setText("")
        self.prescan_show_output.setObjectName("prescan_show_output")
        self.horizontalLayout_4.addWidget(self.prescan_show_output)
        ...
        self.prescan_sensor_select = QtWidgets.QPushButton(window_prescan)
        self.prescan_sensor_select.setMinimumSize(QtCore.QSize(271, 41))
        self.prescan_sensor_select.setStyleSheet("QPushButton{\n"
"border:2px solid rgb(186,186,186);\n"
"background-color: rgb(250,250,250);\n"
"border-radius:10px\n"
"}\n"
...
"border-radius:10px;\n"
"}")
        self.prescan_sensor_select.setObjectName("prescan_sensor_select")
        self.horizontalLayout_3.addWidget(self.prescan_sensor_select)
        spacerItem20 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.horizontalLayout_3.addItem(spacerItem20)
        self.prescan_sensor_show = QtWidgets.QComboBox(window_prescan)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.prescan_sensor_show.sizePolicy().hasHeightForWidth())
        self.prescan_sensor_show.setSizePolicy(sizePolicy)
        self.prescan_sensor_show.setMinimumSize(QtCore.QSize(541, 41))
        self.prescan_sensor_show.setStyleSheet("border:2px solid rgb(186,186,186);\n"
"background-color: rgb(255, 255, 255);\n"
"border-radius:10px")
        self.prescan_sensor_show.setObjectName("prescan_sensor_show")
        self.horizontalLayout_3.addWidget(self.prescan_sensor_show)
        self.gridLayout.addLayout(self.horizontalLayout_3, 13, 3, 1, 1)
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.blank_13 = QtWidgets.QPushButton(window_prescan)
...
"border-radius:25px")
        ...
        self.vtd_vehicle_model_select_6 = QtWidgets.QPushButton(window_prescan)
...
"border-radius:10px")
        ...
        self.blank_14 = QtWidgets.QPushButton(window_prescan)
...
"border-radius:25px")
        ...
        self.to_prescan = QtWidgets.QPushButton(window_prescan)
        self.to_prescan.setMinimumSize(QtCore.QSize(291, 41))
        self.to_prescan.setStyleSheet("QPushButton{\n"
"border:2px solid rgb(85, 87, 83);\n"
...
"border-radius:10px;\n"
"}")
        self.to_prescan.setObjectName("to_carmaker")
        self.horizontalLayout_10.addWidget(self.to_prescan)
        ...
        self.prescan_select_input = QtWidgets.QPushButton(window_prescan)
        self.prescan_select_input.setMinimumSize(QtCore.QSize(271, 41))
        self.prescan_select_input.setStyleSheet("QPushButton{\n"
"border:2px solid rgb(85, 87, 83);\n"
"background-color: rgb(186, 189, 182);\n"
"border-radius:10px\n"
"}\n"
...
"border-radius:10px;\n"
"}")
        self.prescan_select_input.setObjectName("prescan_select_input")
        self.horizontalLayout.addWidget(self.prescan_select_input)
        spacerItem25 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.horizontalLayout.addItem(spacerItem25)
        self.prescan_show_input = QtWidgets.QLineEdit(window_prescan)
        self.prescan_show_input.setMinimumSize(QtCore.QSize(541, 41))
        self.prescan_show_input.setStyleSheet("border:2px solid rgb(186,186,186);\n"
"background-color: rgb(255, 255, 255);\n"
"border-radius:10px")
        self.prescan_show_input.setText("")
        self.prescan_show_input.setObjectName("prescan_show_input")
        self.horizontalLayout.addWidget(self.prescan_show_input)
        self.gridLayout.addLayout(self.horizontalLayout, 5, 3, 1, 1)
        spacerItem26 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem26, 21, 3, 1, 1)

        self.retranslateUi(window_prescan)
        QtCore.QMetaObject.connectSlotsByName(window_prescan)

    def retranslateUi(self, window_prescan):
        _translate = QtCore.QCoreApplication.translate
        window_prescan.setWindowTitle(_translate("window_prescan", "Prescan"))
        self.vtd_vehicle_model_select_3.setText(_translate("window_prescan", "1.选择输入文件"))
        self.vtd_vehicle_model_select_4.setText(_translate("window_prescan", "2.选择车辆模型"))
        self.prescan_vehicle_model_select.setText(_translate("window_prescan", "选择车辆模型"))
        self.vtd_vehicle_model_select_2.setText(_translate("window_prescan", "Prescan"))
        self.vtd_vehicle_model_select_5.setText(_translate("window_prescan", "3.选择传感器模型"))
        self.prescan_select_output.setText(_translate("window_prescan", "输出到Prescan工程目录"))
        self.prescan_sensor_select.setText(_translate("window_prescan", "选择传感器模型"))
        ...
        self.prescan_select_input.setText(_translate("window_prescan", "选择xosc文件"))
